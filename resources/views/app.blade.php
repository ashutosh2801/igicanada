...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <meta name="twitter:title" content="{{ $siteSetting?->twitter_title ?? $siteSetting?->og_title ?? 'IGI Canada' }}">
        ...
        <title inertia>{{ $siteSetting?->default_meta_title ?? config('app.name', 'IGI Canada') }}</title>
        @viteReactRefresh
